...
export default function ClearMonthDataDialog({ isOpen, onClose, allUsers, selectedMonth }) {
        ...
        <div className="space-y-4">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <p className="text-sm text-red-800">
              ...
              for the selected employee for <strong>{format(selectedMonth, 'MMMM yyyy')}</strong>.
            </p>
          </div>
