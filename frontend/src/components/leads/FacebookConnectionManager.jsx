...
export default function FacebookConnectionManager() {
  ...
  const connectMutation = useMutation({
    mutationFn: async () => {
      const response = await base44.functions.invoke('connectFacebookPage', {});
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="text-2xl font-bold text-blue-900">{pages.length}</div>
              <div className="text-xs text-blue-700">Connected Pages</div>
            </div>
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              <div className="text-2xl font-bold text-green-900">{totalForms}</div>
              <div className="text-xs text-green-700">Total Forms</div>
            </div>
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
              <div className="text-2xl font-bold text-purple-900">{subscribedForms}</div>
              <div className="text-xs text-purple-700">Active Webhooks</div>
            </div>
          </div>
